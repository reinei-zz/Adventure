...
namespace Adventure
{
	...
	{
		[DamageAttr(true, true)] Physical = 1,
		[DamageAttr(true, true)] Magical = 2,
		[DamageAttr(true, true)] Item = 4,
		[DamageAttr(false, true)] Poison = 8,
		[DamageAttr(false, true)] Fire = 16,
		
		[DamageAttr(false, false)] Unknown = 2147483648
	}
}
